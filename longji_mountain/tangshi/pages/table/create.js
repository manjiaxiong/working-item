...
Page({
    ...
    onLoad: function(e) {
        ...
        a.utilwmall.request({
            ...
            data: n,
            success: function(n) {
                if (a.utilwmall.loaded(), (n = n.data.message).errno) return -1e3 == n.errno ? (a.utilwmall.toast(n.message.message, "redirect:/tangshi/pages/table/pindan?sid=" + i.data.sid + "&table_id=" + i.data.table_id + "&pindan_id=" + n.message.pindan_id, 1e3), 
                !1) : (a.utilwmall.toast(n.message, "redirect:/tangshi/pages/table/goods?sid=" + i.data.sid + "&table_id=" + i.data.table_id, 1e3), 
                !1);
                n = n.message, i.data.extra = t.extend(d, {
                    ...
                    is_pindan: i.data.is_pindan,
                    pindan_id: i.data.pindan_id
                }), a.utilwmall.setStorageSync("order.extra", i.data.extra);
            }
        });
    },
    onOrderSubmit: function() {
        ...
        if (isNaN(e) || e < 0) a.utilwmall.toast("请输入来客人数"); else {
            t.data.islegal = !1, t.setData({
                islegal: t.data.islegal
            });
            var i = a.utilwmall.getStorageSync("order.extra") || {}, d = {
                sid: t.data.sid,
    ...
    onCalculate: function() {
        ...
        a.utilwmall.request({
            ...
            success: function(e) {
                ...
                t.setData(i), a.utilwmall.setStorageSync("order.extra", t.data.extra);
            }
        });
    },
    onChangeInput: function(t) {
        var e = this, i = t.target.dataset.key, d = t.detail.value;
        e.data.extra[i] = d, e.setData(e.data.extra), a.utilwmall.setStorageSync("order.extra", e.data.extra), 
