...
Page({
    ...
    onLoad: function(a) {
        ...
        if (a) {
            if (a.scene) {
                var o = t.utilwmall.parseScene(a.scene);
                a.sid = o.sid, a.table_id = o.table_id, o.order_id && (a.order_id = o.order_id);
            }
            t.utilwmall.setStorageSync("store", a);
        } else a = t.utilwmall.getStorageSync("store");
        var d = t.utilwmall.getStorageSync("location");
        t.utilwmall.request({
            ...
            success: function(o) {
                ...
                if (o = o.data.message.message, d) return -2 == d ? void t.utilwmall.toast(o, "redirect:/pages/home/index", 1500) : void t.utilwmall.toast(o);
                var i = {
                    page: 2,
                    psize: 30,
                    empty: 0,
                ...
                }), t.utilwmall.setStorageSync("store", o.store), e.onCalculate(), e.data.shareData.title = o.store.title, 
    ...
    onReady: function() {},
    onShow: function() {
        var a = this, e = t.utilwmall.getStorageSync("store");
        a.setData({
    ...
    onPlus: function(a) {
        ...
        if (!1 !== i) {
            ...
            if (s = n.id, c = n.activeOptionId, !n.total) return t.utilwmall.toast("库存不足"), !1;
        }
        var g = {
            sid: e.data.store.id,
            goods_id: s,
