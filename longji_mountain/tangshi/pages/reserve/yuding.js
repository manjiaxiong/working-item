...
Page({
    ...
    onLoad: function(e) {
        var t = this;
        e && e.sid && (t.data.sid = e.sid), a.utilwmall.request({
            ...
            success: function(e) {
                ...
                if (r.errno) return a.utilwmall.toast(r.message), !1;
    ...
    onSelectTime: function(e) {
        ...
        "-1" != r ? t.data.tables_info[t.data.extra.day] && t.data.tables_info[t.data.extra.day][s] && d <= t.data.tables_info[t.data.extra.day][s][r] ? a.utilwmall.toast("该桌台类型下没有可以预订的桌位") : (t.setData({
            "extra.time": r,
            "extra.cid": s
        }), t.data.extra.day || (t.data.extra.day = t.data.year + "-" + t.data.days[t.data.extra.dayIndex].day), 
        a.utilwmall.setStorageSync("reserve.extra", t.data.extra), wx.navigateTo({
            url: "./create?sid=" + t.data.sid
        })) : a.utilwmall.toast("该时间不能预定点餐");
    },
