...
Page({
        ...
        t.utilwmall.request({
            ...
            success: function(a) {
                ...
                if (t.WxParse.wxParse("description", "html", i.goodsDetail.description, o, 5), o.setData({
                    ...
                    store: i.store,
                    goodsActive: e,
                    table_category: i.table_category
                }), o.onCalculate(), o.data.store.data.wxapp) {
                    var n = o.data.store.data.wxapp.extPages.pages_store_goods.navigationBarBackgroundColor;
    ...
    onPlus: function(a) {
        ...
        if ("cart" == e) var s = a.currentTarget.dataset.goodsid, n = a.currentTarget.dataset.optionid; else {
            ...
            if (s = d.id, n = d.activeOptionId, !d.total) return t.utilwmall.toast("库存不足"), !1;
        }
        var r = {
            sid: o.data.store.id,
            goods_id: s,
