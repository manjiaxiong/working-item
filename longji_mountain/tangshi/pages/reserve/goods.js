...
Page({
    ...
    onLoad: function(a) {
        var e = this;
        a ? t.utilwmall.setStorageSync("store", a) : a = t.utilwmall.getStorageSync("store");
        var o = t.utilwmall.getStorageSync("reserve.extra"), d = t.utilwmall.getStorageSync("location");
        t.utilwmall.request({
            ...
            success: function(a) {
                t.utilwmall.loaded();
                var d = a.data.message.errno;
                if (a = a.data.message.message, d) return -2 == d ? void t.utilwmall.toast(a, "redirect:/pages/home/index", 1500) : void t.utilwmall.toast(a);
                var i = {
                    page: 2,
                    psize: 30,
                    empty: 0,
                ...
                if (i.data.length < i.psize && (i.loaded = 1, i.data.length || (i.empty = 1)), e.data.categorySelectedId = a.cid, 
                e.data.childSelectedId = a.child_id, e.data.goodsAll[e.data.categorySelectedIndex] = [], 
                e.data.goodsAll[e.data.categorySelectedIndex][e.data.childSelectedIndex] = i, e.data.store = a.store, 
                ...
                e.setData({
                    ...
                    extra: o
                }), t.utilwmall.setStorageSync("store", a.store), e.onCalculate(), e.data.shareData.title = a.store.title, 
                e.data.shareData.path = "/pages/store/goods?sid=" + a.store.id, wx.setNavigationBarTitle({
                    ...
                    var s = e.data.store.data.wxapp.extPages.pages_store_goods.navigationBarBackgroundColor;
    ...
    onReady: function() {},
    onShow: function() {
        var a = this, e = t.utilwmall.getStorageSync("store"), o = t.utilwmall.getStorageSync("reserve.extra");
        a.setData({
    ...
    onPlus: function(a) {
        ...
        if (!1 !== i) {
            ...
            if (s = n.id, l = n.activeOptionId, !n.total) return t.utilwmall.toast("库存不足"), !1;
        }
        var g = {
            sid: e.data.store.id,
        ...
        t.utilwmall.request({
            ...
            data: g,
            success: function(a) {
                if ((a = a.data.message).errno) return t.utilwmall.toast(a.message), !1;
                a.message.msg && t.utilwmall.toast(a.message.msg);
                var r = {
                    cart: a.message.cart
                };
                if (!1 !== i) {
                    var c = e.data.goodsActive;
                    if (c.options_data[g.option_id].num) c.options_data[g.option_id].num++, c.totalnum++; else {
                        var n = a.message.cart.data1[s][l].num;
                        c.options_data[g.option_id].num = n, c.totalnum += n;
                    }
                    1 != c.is_options && 1 != c.is_attrs || (c.activeOption.num = c.options_data[g.option_id].num), 
                    "detail" == d && (e.data.goodsDetail.totalnum ? e.data.goodsDetail.totalnum++ : e.data.goodsDetail.totalnum = 1), 
                    e.data.goodsAll[e.data.categorySelectedIndex][e.data.childSelectedIndex].data[o] = c, 
                    r = {
                        cart: a.message.cart,
                        goodsAll: e.data.goodsAll,
        ...
        t.utilwmall.request({
            ...
            success: function(a) {
                ...
                if (!1 !== i) {
                    ...
                    if (a.message.cart.data1[s]) if (a.message.cart.data1[s][c]) r.totalnum--, r.options_data[g.option_id].num--; else {
                        var l = r.options_data[g.option_id].num;
                        r.options_data[g.option_id].num = 0, r.totalnum -= l;
    ...
    onCollectCoupon: function() {
        ...
        t.utilwmall.request({
            ...
            success: function(e) {
                0 == e.data.message.errno ? (t.utilwmall.toast(e.data.message.message), a.setData({
                    couponStatus: 0
                })) : t.utilwmall.toast("领取失败");
            }
        });
    },
    ...
    onGetGoods: function() {
        ...
        a.data.goodsLoading = 1, t.utilwmall.request({
    ...
    onFavor: function(a) {
        ...
        t.utilwmall.request({
            ...
            data: s,
            success: function(a) {
                0 == a.data.message.errno ? "star" == i ? (t.utilwmall.toast("添加收藏成功"), d.is_favorite = !d.is_favorite, 
                e.setData({
                    store: d
                })) : (t.utilwmall.toast("取消收藏成功"), d.is_favorite = !d.is_favorite, e.setData({
                    store: d
                })) : t.utilwmall.toast(a.data.message.message);
            }
        });
    },
