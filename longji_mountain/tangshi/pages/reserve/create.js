...
Page({
    ...
    onLoad: function(a) {
        var r = this;
        r.data.sid = a.sid || 3;
        var s = t.utilwmall.getStorageSync("reserve.extra") || {};
        ...
        t.utilwmall.request({
            ...
            data: o,
            success: function(s) {
                t.utilwmall.loaded(), (s = s.data.message).errno ? t.utilwmall.toast(s.message, "/tangshi/pages/reserve/index?sid=" + r.data.sid, 1e3) : (s = s.message, 
                ...
                r.data.extra.mobile || (r.data.extra.mobile = s.order.mobile), r.setData({
                    ...
                    islegal: s.islegal,
                    extra: r.data.extra
                }), t.utilwmall.setStorageSync("reserve.extra", r.data.extra));
            }
        });
    },
    onOrderSubmit: function() {
        var e = this, a = t.utilwmall.getStorageSync("reserve.extra") || {};
        if (!a.username || !a.mobile) return t.utilwmall.toast("请完善预订人信息"), !1;
        if (!a.cid) return t.utilwmall.toast("请先选择预定桌台"), !1;
        if (!a.time || !a.day) return t.utilwmall.toast("请先选择预定时间"), !1;
                ...
                return wx.showToast({
                    ...
                    success: function() {
                        wx.removeStorageSync("order"), wx.navigateTo({
                            url: "../../../lala/public/pay?order_id=" + a + "&order_type=takeout"
                        });
                    }
                }), !1;
            }
    ...
    onCalculate: function() {
        ...
        t.utilwmall.request({
            ...
            success: function(a) {
                ...
                e.setData(r), t.utilwmall.setStorageSync("reserve.extra", e.data.extra);
            }
        });
    },
    ...
    onChangeInput: function(e) {
        ...
        a.data.extra[r] = s, a.setData(a.data.extra), t.utilwmall.setStorageSync("reserve.extra", a.data.extra);
    },
    ...
    onChangeOrderType: function(e) {
        ...
        }), t.utilwmall.setStorageSync("reserve.extra", a.data.extra), "order" == r ? wx.redirectTo({
    ...
    onSelectTable: function(e) {
        ...
        }), t.utilwmall.setStorageSync("reserve.extra", this.data.extra)) : t.utilwmall.toast("该桌位已被他人提前预定, 请选择其他桌号", "", 1e3);
    },
    onSelectPersonNum: function(e) {
        var a = parseInt(e.detail.value);
        a += 1, this.setData({
            "extra.person_num": a
        }), t.utilwmall.setStorageSync("reserve.extra", this.data.extra);
    },
    onReady: function() {},
    onShow: function() {
        console.log("监听页面显示");
