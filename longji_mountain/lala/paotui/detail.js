...
Page({
    ...
    onLoad: function(e) {
        ...
        a.utilwmall.request({
            ...
            success: function(e) {
                a.utilwmall.loaded(), t.data.config_mall = e.data.message.message.config_mall, t.setData({
    ...
    onShowImage: function(e) {
        a.utilwmall.showImage(e);
    },
    onCallDeliveryer: function(e) {
        var t = this, s = e.currentTarget.dataset.type;
        t.data.order && "1" == t.data.order.data.yinsihao_status ? a.utilwmall.request({
            ...
            success: function(e) {
                if (e.data.message.errno) return -1e3 == e.data.message.errno ? t.onMakePhoneCall() : -2 == e.data.message.errno ? t.onToggleServicePopupStatus() : a.utilwmall.toast(e.data.message.message), 
                !1;
