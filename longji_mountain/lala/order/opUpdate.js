...
Page({
    ...
    onLoad: function(t) {
        var a = this;
        t && t.id > 0 && (a.data.id = t.id), t && t.type && (a.data.type = t.type), e.utilwmall.request({
            ...
            success: function(t) {
                ...
                if (o.errno) return e.utilwmall.toast(o.message), !1;
                a.setData({
    ...
    onSubmit: function(t) {
        ...
        if (a.data.islegal) {
            ...
            if ("note" == i) r.note = o.note; else if ("mobile" == i) {
                if (!o.mobile) return void e.utilwmall.toast("请输入手机号");
                if (!e.utilwmall.isMobile(o.mobile)) return void e.utilwmall.toast("手机号格式错误");
                r.mobile = o.mobile;
            ...
            a.setData({
                ...
                success: function(t) {
                    ...
                    if (i.errno) return e.utilwmall.toast(i.message), a.setData({
                        islegal: !0
                    }), !1;
                    e.utilwmall.toast(i.message, "redirect:/lala/order/op?id=" + o.id, 1500);
                }
            });
        }
    },
