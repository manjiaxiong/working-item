...
Page({
    ...
    onLoad: function(t) {
        var e = this;
        t && (e.data.options = t);
        var o = a.utilwmall.getStorageSync("location");
        o && o.x ? (e.setData({
            location: o
        }), e.onGetIndex()) : a.utilwmall.getLocation(function(t) {
            ...
            e.setData({
                ...
                x: o.latitude,
                y: o.longitude
            }, a.utilwmall.setStorageSync("location", o, 600), e.onGetIndex();
        });
    },
    onGetIndex: function() {
        var t = this, e = a.utilwmall.getStorageSync("location");
        if (e) {
            ...
            a.utilwmall.request({
                ...
                success: function(e) {
                    ...
                    if (o.errno) return a.utilwmall.toast(o.message), !1;
                    ...
                    s && s.params && 1 == s.params.status && (t.setData({
                        has_diy_guide: !0
                    }), s && "everytime" == s.params.show_setting && a.utilwmall.getStorageSync("storage") && a.utilwmall.setStorageSync("storage", {}, 0), 
                    o.message.storage = a.utilwmall.getStorageSync("storage"), !s || "interval" != s.params.show_setting || o.message.storage && o.message.storage.storageGuide || a.utilwmall.setStorageSync("storage", {
                        storageGuide: 1
                    ...
                    o.message.stores.stores = a.utilwmall.getStore(o.message.stores.stores, "array"), t.data.store.data = o.message.stores.stores, 
        ...
        } else a.utilwmall.toast("获取位置失败,请重新进入小程序");
    },
    ...
    onGetStore: function(t) {
        ...
        var o = a.utilwmall.getStorageSync("location"), i = {
            lat: o.x,
            lng: o.y,
    ...
    onGetInformation: function() {
        var t = this;
        t.data.tongcheng.loaded || a.utilwmall.request({
    ...
    onGetHaoDian: function(t) {
        ...
        t && (e.data.haodian = {
            ...
            data: [],
            loading: 1
        }), e.data.haodian.loaded || a.utilwmall.request({
    ...
    onShow: function() {
        var t = this;
        t.data.diy && 1 == t.data.diy.is_show_cart && a.utilwmall.request({
