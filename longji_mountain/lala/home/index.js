...
Page({
    data: {
        theme: t.utilwmall.getStorageSync("theme"),
        is_use_diy: 1,
        address: "定位中。。。",
        showNodata: !1,
        config: {
    ...
    onGetIndex: function() {
        var a = this, e = t.utilwmall.getStorageSync("location");
        if (e) {
            var o = {
                lat: e.x,
                lng: e.y,
            ...
            a.setData({
                ...
                success: function(e) {
                    ...
                    if (s.errno) return t.utilwmall.toast(s.message), !1;
                    if (2 != (s = s.message).config.version) {
                        ...
                        a.data.store.loading = 0, s.stores.stores = t.utilwmall.getStore(s.stores.stores, "array"), 
                        ...
                        if (i && 0 == i.errno && i.message.page && (s.superRedpacket = {
                            ...
                            n && n.params && 1 == n.params.status && (a.setData({
                                has_diy_guide: !0
                            }), n && "everytime" == n.params.show_setting && t.utilwmall.getStorageSync("storage") && t.utilwmall.setStorageSync("storage", {}, 0), 
                            s.storage = t.utilwmall.getStorageSync("storage"), !n || "interval" != n.params.show_setting || s.storage && s.storage.storageGuide || t.utilwmall.setStorageSync("storage", {
                                storageGuide: 1
                            }, 60 * n.params.interval_time));
                        }
                        if (!a.data.has_diy_guide) {
                            var l = s.guide;
                            l && "everytime" == l.params.show_setting && t.utilwmall.getStorageSync("storage") && t.utilwmall.setStorageSync("storage", {}, 0), 
                            s.storage = t.utilwmall.getStorageSync("storage"), !l || "interval" != l.params.show_setting || s.storage && s.storage.storageGuide || t.utilwmall.setStorageSync("storage", {
                                storageGuide: 1
                        ...
                        if (a.setData(s), o.code && s.spread) if (0 == s.spread.errno) {
                            ...
                            t.utilwmall.toast(c);
                        } else -1 == s.spread.errno && t.utilwmall.toast(s.spread.message);
        ...
        } else t.utilwmall.toast("获取位置失败,请重新进入小程序");
    },
    onGetStore: function(a) {
        ...
        var o = t.utilwmall.getStorageSync("location"), s = {
            lat: o.x,
            lng: o.y,
        ...
        t.utilwmall.request({
            ...
            success: function(a) {
                ...
                o.stores = t.utilwmall.getStore(o.stores, "array"), e.data.store.data = e.data.store.data.concat(o.stores), 
    ...
    onLoad: function(a) {
        var e = this;
        if (a && (e.data.options = a), t.utilwmall.setStorageSync("onloadHome", 1), a && a.sid > 0) {
            var o = e.data.options.sid, s = "/lala/store/goods?sid=" + o;
            return "home" == e.data.options.from && (s = "/lala/store/home?sid=" + o), void t.utilwmall.jump2url(s);
        }
        var i = t.utilwmall.getStorageSync("location");
        i && i.x ? (e.setData({
            location: i
        }), e.onGetIndex()) : t.utilwmall.getLocation(function(a) {
            var o = a.data.message.message;
            e.setData({
                location: o
            }), o = {
                ...
                x: o.latitude,
                y: o.longitude
            }, t.utilwmall.setStorageSync("location", o, 600), e.onGetIndex();
        });
    },
    ...
    onHide: function() {
        t.utilwmall.removeStorageSync("onloadHome");
    },
    onShow: function() {
        var a = this;
        if (1 == t.utilwmall.getStorageSync("location").onshow || a.data.options && a.data.options.sid > 0) return a.data.store = {
            page: 1,
            psize: 20,
            loaded: 0,
            empty: 0,
        ...
        1 != t.utilwmall.getStorageSync("onloadHome") && t.utilwmall.request({
    ...
    getCoupon: function(a) {
        ...
        t.utilwmall.request({
            ...
            success: function(a) {
                0 == a.data.message.errno ? (t.utilwmall.toast(a.data.message.message), e.setData({
                    is_grant: 1
