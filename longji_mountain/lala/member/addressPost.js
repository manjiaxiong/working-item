...
Page({
    ...
    onChooseLocation: function(e) {
        var t = this;
        a.utilwmall.setStorageSync("address", t.data.address), wx.chooseLocation({
            success: function(e) {
                t.data.address = a.utilwmall.getStorageSync("address"), t.data.address.location_x = e.latitude, 
                t.data.address.location_y = e.longitude, t.data.address.address = e.name, t.setData({
                    address: t.data.address
                });
            },
            cancel: function(e) {
                a.utilwmall.toast("取消后不能选择位置");
            }
        });
    },
    onFormChange: function(e) {
        var t = this, d = e.currentTarget.dataset.type;
        t.data.address[d] = e.detail.value, a.utilwmall.setStorageSync("address", t.data.address);
    },
            ...
            wx.showModal({
                ...
                success: function(e) {
                    if (e.confirm) ; else if (e.cancel) {
                        a.utilwmall.jump2url("/lala/home/index", "redirectTo");
                    }
                }
            });
        }
    ...
    onSubmit: function(t) {
        ...
        if (1 == d.data.address.store.auto_get_address && !d.data.address.location_x) return a.utilwmall.toast("收货地址不能为空"), 
        !1;
        if (!s.realname) return a.utilwmall.toast("联系人不能为空"), !1;
        if (!s.mobile) return a.utilwmall.toast("手机号不能为空"), !1;
        if (!a.utilwmall.isMobile(s.mobile)) return a.utilwmall.toast("手机号格式错误"), !1;
        if ("1" == d.data.address.address_type) {
            if (!s.number) return a.utilwmall.toast("门牌号不能为空"), !1;
            if (!a.utilwmall.isNumber(s.number)) return a.utilwmall.toast("门牌号只能是数字"), !1;
        }
        d.data.submiting = 1;
        var r = {
        ...
        a.utilwmall.request({
            ...
            success: function(t) {
                ...
                if (!d.data.options.channel || "" == d.data.options.channel || "undefined" == d.data.options.channel) return s.errno ? (a.utilwmall.toast(s.message), 
                !1) : void a.utilwmall.jump2url("/lala/member/address", "redirectTo");
                if ("takeout" == d.data.options.channel) if (-1e3 == s.errno) wx.showModal({
                    ...
                    cancelText: "仍然保存",
                    success: function(e) {
                        e.confirm || e.cancel && (r.force = 1, a.utilwmall.request({
                            method: "POST",
                            url: "wmall/member/address/post",
                            data: r,
                            success: function(e) {
                                d.data.orderId > 0 ? a.utilwmall.jump2url("/lala/order/address?id=" + d.data.orderId, "redirectTo") : (wx.removeStorageSync("address"), 
                                a.utilwmall.jump2url(d.data.orderUrl, "redirectTo"));
                            }
                        }));
                    }
                }); else {
                    if (s.errno) return a.utilwmall.toast(s.message), !1;
                    d.data.orderId > 0 ? a.utilwmall.jump2url("/lala/order/address?id=" + d.data.orderId, "redirectTo") : (wx.removeStorageSync("address"), 
                    (i = a.utilwmall.getStorageSync("order.extra")) && (i = e.extend(i, {
                        address_id: s.message
                    })), a.utilwmall.setStorageSync("order.extra", i), a.utilwmall.jump2url(d.data.orderUrl, "redirectTo"));
                    ...
                    cancelText: "仍然保存",
                    success: function(e) {
                        e.confirm ? wx.hideModal() : e.cancel && (r.force = 1, a.utilwmall.request({
                            method: "POST",
                            url: "wmall/member/address/post",
                            data: r,
                            success: function(e) {
                                wx.removeStorageSync("address");
                                var t = "/lala/paotui/diy?id=" + d.data.options.erranderId;
                                a.utilwmall.jump2url(t, "redirectTo");
                            }
                        }));
                    }
                }); else {
                    if (s.errno) return a.utilwmall.toast(s.message), !1;
                    wx.removeStorageSync("address");
                    var i = a.utilwmall.getStorageSync("errander.extra");
                    i && (i = "buy" == d.data.options.input ? e.extend(i, {
                        buyaddress_id: s.message
                    }) : e.extend(i, {
                        acceptaddress_id: s.message
                    })), a.utilwmall.setStorageSync("errander.extra", i);
                    var o = "/lala/paotui/diy?id=" + d.data.options.erranderId;
                    a.utilwmall.jump2url(o, "redirectTo");
                }
            }
        });
    },
                    ...
                    a.utilwmall.request({
                        ...
                        success: function(t) {
                            if (0 == t.data.message.errno) {
                                var d = "/lala/member/address";
                                e.data.address.sid > 0 && (d = e.data.addressUrl), a.utilwmall.jump2url(d, "redirectTo");
                            }
                        }
                    });
                }
