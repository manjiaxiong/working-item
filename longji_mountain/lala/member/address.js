...
Page({
    ...
    onSelectAddress: function(t) {
        ...
        if (!d) return e.utilwmall.toast("该地址不在商家配送范围内"), !1;
        if ("errander" == n.data.channel) {
            (i = e.utilwmall.getStorageSync("errander.extra")) && (i = "buy" == n.data.input ? a.extend(i, {
                buyaddress_id: r
            }) : a.extend(i, {
                acceptaddress_id: r
            })), e.utilwmall.setStorageSync("errander.extra", i);
            var s = "/lala/paotui/diy?id=" + n.data.erranderId;
            return e.utilwmall.jump2url(s, "redirectTo"), !1;
        }
        var i = e.utilwmall.getStorageSync("order.extra");
        i && (i = a.extend(i, {
            address_id: r
        })), e.utilwmall.setStorageSync("order.extra", i), e.utilwmall.jump2url(n.data.orderUrl, "redirectTo");
    },
            ...
            success: function(r) {
                ...
                e.utilwmall.request({
                    ...
                    success: function(r) {
                        ...
                        if (!t.data.channel || "" == t.data.channel || "undefined" == t.data.channel) return n.errno ? (e.utilwmall.toast(n.message), 
                        ...
                        if ("takeout" == t.data.channel) if (-1e3 == n.errno) wx.showModal({
                            ...
                            cancelText: "仍然保存",
                            success: function(a) {
                                a.confirm ? wx.hideModal() : a.cancel && (d.force = 1, e.utilwmall.request({
                                    method: "POST",
                                    url: "wmall/member/address/wxaddress_add",
                                    data: d,
                                    success: function(a) {
                                        e.utilwmall.jump2url(t.data.orderUrl, "redirectTo");
                                    }
                                }));
                            }
                        }); else {
                            if (n.errno) return e.utilwmall.toast(n.message), !1;
                            (s = e.utilwmall.getStorageSync("order.extra")) && (s = a.extend(s, {
                                address_id: n.message
                            })), e.utilwmall.setStorageSync("order.extra", s), e.utilwmall.jump2url(t.data.orderUrl, "redirectTo");
                            ...
                            success: function(a) {
                                a.confirm ? wx.hideModal() : a.cancel && (d.force = 1, e.utilwmall.request({
                                    ...
                                    data: d,
                                    success: function(a) {
                                        var r = "/lala/paotui/diy?id=" + t.data.erranderId;
                                        e.utilwmall.jump2url(r, "redirectTo");
                                    }
                                }));
                            }
                        }); else {
                            if (n.errno) return e.utilwmall.toast(n.message), !1;
                            var s = e.utilwmall.getStorageSync("errander.extra");
                            s && (s = "buy" == t.data.input ? a.extend(s, {
                                buyaddress_id: n.message
                            }) : a.extend(s, {
                                acceptaddress_id: n.message
                            })), e.utilwmall.setStorageSync("errander.extra", s);
                            var i = "/lala/paotui/diy?id=" + t.data.erranderId;
                            e.utilwmall.jump2url(i, "redirectTo");
                        }
                    }
                });
            },
