    ...
    onLoad: function() {
        ...
        t.utilwmall.request({
            ...
            success: function(a) {
                ...
                if (o.errno) t.utilwmall.toast(o.message, "", 3e3); else {
                    if (o = o.message, o.credit2 = t.utilwmall.getStore(o.credit2, "random"), 1 != o.is_use_diy) t.WxParse.wxParse("copyright", "html", o.config.mall.copyright, e, 0); else {
