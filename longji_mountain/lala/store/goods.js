...
Page({
    ...
    onLoad: function(a) {
        ...
        if (a) {
            if (a.scene) {
                ...
                t.utilwmall.setStorageSync("store", d), a.sid = d;
            } else t.utilwmall.setStorageSync("store", a.sid);
            a.pindan_id && (e.data.pindan_id = a.pindan_id);
        } else a = t.utilwmall.getStorageSync("store");
        ...
        t.utilwmall.request({
            ...
            success: function(a) {
                ...
                if (a = a.data.message.message, d) return -2 == d ? void t.utilwmall.toast(a, "redirect:/lala/home/index", 1500) : void t.utilwmall.toast(a);
                ...
                }), t.utilwmall.setStorageSync("store", a.store), t.utilwmall.selectPindan({
                    pindan_id: e.data.pindan_id,
                ...
                var i = "/lala/store/goods?sid=" + a.store.id;
                if (1 == a.config_mall.version && (i = "/lala/home/index?sid=" + a.store.id), e.data.shareData.path = i, 
                ...
                if (e.data.store.tips) {
                    var c = "storeNotice" + e.data.store.id, l = t.utilwmall.getStorageSync(c);
                    (!l || l && !l.notice) && (t.utilwmall.setStorageSync(c, {
                        notice: 1
                    }, 300), e.setData({
                        showNotice: !0,
                ...
                e.data.store.menu && "1" == e.data.store.menu.path.goods && t.utilwmall.setNavigator(e.data.menu);
            }
        });
    },
    ...
    onShow: function() {
        ...
        var e = t.utilwmall.getStorageSync("store");
    ...
    onUpdateCartData: function() {
        ...
        t.utilwmall.request({
            ...
            success: function(e) {
                if ((e = e.data.message).errno) return t.utilwmall.toast(e.message), !1;
    ...
    onPlus: function(a) {
        ...
        if (1 == e.data.cart.is_buysvip && (o = 1), "selectSvip" == a.detail.from) {
            ...
            if (!1 !== u) {
                ...
                if (i = p.id, s = p.activeOptionId, !p.total) return t.utilwmall.toast("库存不足"), !1;
            }
