...
Page({
    ...
    onLoad: function(a) {
        ...
        t.utilwmall.request({
            ...
            success: function(a) {
                ...
                }), e.data.shareData.title = s.title, e.data.shareData.path = "/lala/store/goods?sid=" + s.id, 
    ...
    onFavor: function(a) {
        ...
        t.utilwmall.request({
            ...
            data: r,
            success: function(a) {
                0 == a.data.message.errno ? "star" == o ? (t.utilwmall.toast("添加收藏成功"), i.is_favorite = !i.is_favorite, 
                e.setData({
                    store: i
                })) : (t.utilwmall.toast("取消收藏成功"), i.is_favorite = !i.is_favorite, e.setData({
                    store: i
