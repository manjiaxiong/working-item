...
Page({
    ...
    onLoad: function(a) {
        ...
        t.utilwmall.request({
            ...
            success: function(a) {
                ...
                if (o.errno) return t.utilwmall.toast(o.message), !1;
                var i = t.utilwmall.getStorageSync("isearchHistory.goods" + e.data.sid);
                i && (e.data.searchHistory = i);
                var s = "pages/store/goodsDetail?sid=" + o.message.store.id + "&pindan_id=" + e.data.pindan_id;
                if (e.data.table_id > 0 && (s = "tangshi/lala/table/goodsDetail?sid=" + o.message.store.id + "&table_id=" + e.data.table_id), 
                e.setData({
    ...
    onSearch: function(a) {
        ...
        t.utilwmall.setStorageSync("isearchHistory.goods" + e.data.sid, e.data.searchHistory)), 
        e.data.keyword ? e.onReachBottom(!0) : t.utilwmall.toast("请输入搜索条件");
    },
    onDeleteHistory: function() {
        ...
        wx.showModal({
            content: "确定清空搜索历史吗",
            success: function(e) {
                e.confirm ? (t.utilwmall.removeStorageSync("isearchHistory.goods." + a.data.sid), a.setData({
                    searchHistory: []
                })) : e.cancel;
            }
        });
    ...
    onReachBottom: function(a) {
        ...
        1 == a && (e.data.records = {
            ...
            loaded: !1,
            data: []
        }), e.data.records.loaded || t.utilwmall.request({
            url: "wmall/store/goods/search",
            data: {
    ...
    onChangeCart: function(a) {
        ...
        if (1 == e.data.cart.is_buysvip && (o = 1), "selectSvip" == a.detail.from) {
            ...
            if (!1 !== p) {
                ...
                if (d = g.id, r = g.activeOptionId, !g.total && "plus" == i) return t.utilwmall.toast("库存不足"), 
                !1;
            }
        ...
        e.data.table_id > 0 && (_ = "wmall/store/table/cart"), t.utilwmall.request({
            url: _,
            data: v,
            success: function(a) {
    ...
    onSubmit: function() {
        ...
        t.utilwmall.jump2url(e, "navigateTo");
    },
