...
Page({
    ...
    onLoad: function(t) {
        ...
        var d = a.utilwmall.getStorageSync("errander.extra") || {};
        ...
        a.utilwmall.request({
            ...
            success: function(t) {
                if (a.utilwmall.loaded(), 0 != (t = t.data.message).errno) return a.utilwmall.toast(t.message, ""), 
                !1;
                ...
                a.utilwmall.setStorageSync("errander.extra", r.data.extra), wx.setNavigationBarTitle({
    ...
    onCalculate: function() {
        ...
        console.log("cccccccccccccc"), console.log(t), a.utilwmall.request({
            url: "errander/diy/index",
            data: t,
            success: function(t) {
                ...
                a.utilwmall.toast(t.message, "", 1e3), !1;
                (t = t.message).buyaddress && t.buyaddress.errno && a.utilwmall.toast(t.buyaddress.message), 
    ...
    onOrderSubmit: function() {
        ...
        if (!e.data.extra.note) return a.utilwmall.toast("请填写物品信息", "", 1500), !1;
        if ("buy" != e.data.diy.data.page.scene) {
            if (!e.data.buyaddress) return a.utilwmall.toast("请选择取货地址", "", 1500), !1;
            if (!a.utilwmall.isMobile(e.data.buyaddress.mobile)) return a.utilwmall.toast("取货联系人手机号格式不正确", "", 1500), 
            !1;
        }
        if (!e.data.acceptaddress) return a.utilwmall.toast("请选择收货地址", ""), !1;
        if (!a.utilwmall.isMobile(e.data.acceptaddress.mobile)) return a.utilwmall.toast("收货联系人手机号格式不正确", "", 1500), 
        !1;
        if (1 == e.data.diy.data.fees.weight_status && !e.data.extra.goods_weight) return a.utilwmall.toast("请选择物品重量", "", 1500), 
        !1;
        var t = {
            id: e.data.options.id || 10,
            extra: e.data.extra
        };
        e.data.submitDisabled = 1, a.utilwmall.request({
            url: "errander/orderdiy/create",
            data: t,
            success: function(t) {
                if ((t = t.data.message).errno) return e.data.submitDisabled = 0, a.utilwmall.toast(t.message, ""), 
                !1;
                var r = t.message;
                return wx.showToast({
                    title: "下单成功",
    ...
    onHide: function() {
        var e = this;
        e.data.extra.notes[e.data.options.id] = e.data.extra.note, a.utilwmall.setStorageSync("errander.extra", e.data.extra);
    },
    onUnload: function() {
        var e = this;
        e.data.extra.notes[e.data.options.id] = e.data.extra.note, a.utilwmall.setStorageSync("errander.extra", e.data.extra);
