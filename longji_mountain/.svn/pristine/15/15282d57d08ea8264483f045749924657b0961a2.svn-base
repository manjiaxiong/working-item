...
Page({
    ...
    onLoad: function(a) {
        ...
        t.data.options = a, t.setData({
            ...
            success: function(a) {
                if (e.utilwmall.loaded(), a.data.message.errno) return e.utilwmall.toast(a.data.message.message), 
                !1;
    ...
    onCallStoreOrDeliveryer: function(a) {
        ...
        t.data.detail.order && "1" == t.data.detail.order.data.yinsihao_status ? e.utilwmall.request({
            ...
            success: function(a) {
                if (a.data.message.errno) return -1e3 == a.data.message.errno ? t.onMakePhoneCall(o) : -2 == a.data.message.errno ? t.onToggleServicePopupStatus() : e.utilwmall.toast(a.data.message.message), 
                !1;
