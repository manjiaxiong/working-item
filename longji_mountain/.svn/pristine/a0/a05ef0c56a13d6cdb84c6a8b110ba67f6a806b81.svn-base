...
Page({
    ...
    onLoad: function(a) {
        var s = this;
        a && a.id > 0 && (s.data.id = a.id), e.utilwmall.request({
            ...
            success: function(a) {
                ...
                if (t.errno) return e.utilwmall.toast(t.message), !1;
                s.setData({
    ...
    onSubmit: function() {
        ...
        s < 0 || !a.data.addresses.available[s] || !a.data.islegal || (a.setData({
            ...
            success: function(s) {
                ...
                if (t.errno) return e.utilwmall.toast(t.message), a.setData({
                    islegal: !1
                }), !1;
                e.utilwmall.toast(t.message, "redirect:/lala/order/detail?id=" + a.data.order.id, 1500);
            }
        }));
    },
