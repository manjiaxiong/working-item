...
Page({
    ...
    onLoad: function(a) {
        ...
        t.utilwmall.request({
            ...
            success: function(n) {
                ...
                (o = i.extend(o, t.utilwmall.getStorageSync("order.note"))).invoice_status && (o.invoices = d.invoices), 
                e.setData(o);
            }
        });
    },
    ...
    onSubmit: function(a) {
        ...
        }, d = t.utilwmall.getStorageSync("order.extra");
        d && (d = i.extend(d, n)), t.utilwmall.setStorageSync("order.extra", d), t.utilwmall.setStorageSync("order.note", n), 
        wx.redirectTo({
