...
Page({
    ...
    onLoad: function(t) {
        var e = this;
        if (!(t && t.id > 0)) return a.utilwmall.toast("订单不存在或已删除！"), !1;
        e.data.id = t.id, a.utilwmall.request({
            ...
            success: function(t) {
                ...
                if (s.errno) return a.utilwmall.toast(s.message, "/lala/order/detail?id=" + e.data.id, 3e3), 
                !1;
