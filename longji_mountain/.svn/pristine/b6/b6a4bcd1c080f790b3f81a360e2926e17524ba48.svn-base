...
Page({
    ...
    onLoad: function(a) {
        var e = this;
        a && a.sid && (e.data.sid = a.sid), t.utilwmall.request({
            ...
            success: function(a) {
                ...
                }), e.data.shareData.title = a.store.title, e.data.shareData.path = "/lala/store/goods?sid=" + a.store.id, 
    ...
    onFavor: function(a) {
        ...
        t.utilwmall.request({
            ...
            data: n,
            success: function(a) {
                0 == a.data.message.errno ? "star" == i ? (t.utilwmall.toast("添加收藏成功"), o.is_favorite = !o.is_favorite, 
                e.setData({
                    store: o
                })) : (t.utilwmall.toast("取消收藏成功"), o.is_favorite = !o.is_favorite, e.setData({
                    store: o
