...
Page({
    ...
    onLoad: function(a) {
        ...
        t.data.options = a, e.utilwmall.request({
            ...
            success: function(a) {
                ...
                o.errno && e.utilwmall.toast(o.message);
                var s = a.data.global, n = "/lala/store/home?sid=" + t.data.options.sid;
                1 == o.message.config_mall.version && (n = "/lala/home/index?from=home&sid=" + t.data.options.sid);
                var i = {
                    title: s.share.title,
                    desc: s.share.desc,
                ...
                t.data.store.menu && "1" == t.data.store.menu.path.home && e.utilwmall.setNavigator(t.data.menu), 
    ...
    getCoupon: function(a) {
        ...
        e.utilwmall.request({
            ...
            success: function(a) {
                0 == a.data.message.errno ? (e.utilwmall.toast(a.data.message.message), t.setData({
                    is_grant: 1
                })) : e.utilwmall.toast("领取失败");
            }
        });
    },
