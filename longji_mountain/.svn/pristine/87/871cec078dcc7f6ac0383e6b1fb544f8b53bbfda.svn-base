...
Page({
    ...
    onLoad: function(t) {
        ...
        var d = a.utilwmall.getStorageSync("order.extra") || {}, r = {
            sid: t.sid,
            extra: d,
        ...
        a.utilwmall.request({
            ...
            data: r,
            success: function(r) {
                if (a.utilwmall.loaded(), (r = r.data.message).errno) return a.utilwmall.toast(r.message, "", 1e3), 
                !1;
                ...
                }), a.utilwmall.setStorageSync("order.extra", s.data.extra), s.onCheckSendPrice(r.message, r.address);
            }
        });
    },
    onChangePersonNum: function(e) {
        ...
        t.setData({
            person_num: s
        }), this.data.extra.person_num = s, a.utilwmall.setStorageSync("order.extra", t.data.extra);
    },
    ...
    onJsEvent: function(e) {
        a.utilwmall.jsEvent(e);
    },
    onOrderSubmit: function(e) {
        var t = this;
        if (2 == t.data.extra.order_type) {
            var s = e.detail.value.mobile;
            if (!s) return a.utilwmall.toast("请输入提货手机号", ""), !1;
            t.data.extra.mobile = s;
        }
        if (!(1 != t.data.extra.order_type && t.data.extra.order_type || t.data.extra.address_id || 2 == t.data.store.delivery_type)) return a.utilwmall.toast("请选择收货地址", ""), 
        !1;
        if (!t.data.islegal) return !1;
        t.data.islegal = !1, t.setData({
            islegal: t.data.islegal
        });
        var d = a.utilwmall.getStorageSync("order.extra") || {};
    ...
    onSubmitPost: function(e) {
        ...
        a.utilwmall.request({
            ...
            data: s,
            success: function(e) {
                if ((e = e.data.message).errno) return 1e3 == e.errno ? (a.utilwmall.toast(e.message, "../store/goods?sid=" + s.sid), 
                !1) : (a.utilwmall.toast(e.message, ""), !1);
                var t = e.message;
                return wx.showToast({
                    title: "下单成功",
                    success: function() {
    ...
    onCalculate: function() {
        ...
        a.utilwmall.request({
            ...
            success: function(t) {
                ...
                t.huangou && (t.huangou.message.errno && a.utilwmall.toast(t.huangou.message.message, "", 2e3), 
                t.huangou.cart_message && a.utilwmall.toast(t.huangou.cart_message, "", 3e3)), e.data.goods_id = 0, 
                e.data.sign = "", e.setData(s), a.utilwmall.setStorageSync("order.extra", e.data.extra), 
    ...
    onCheckSendPrice: function(e, t) {
        ...
        if ("noReachSendPrice" == e.errno) {
            if (t) {
                ...
                a.utilwmall.setStorageSync("location", d, 600);
            }
            return a.utilwmall.toast(e.message, "../store/goods?sid=" + s.data.sid, 3e3), !1;
        }
        return !0;
    },
    ...
    onConfirmSvipExchange: function() {
        ...
        "exchange" == s && (t = e.data.svip_redpacket.store_redpacket.id), a.utilwmall.request({
            ...
            success: function(t) {
                if ((t = t.data.message).errno) return a.utilwmall.toast(t.message), !1;
                var d = "领取成功";
                "exchange" == s && (d = "兑换成功"), a.utilwmall.toast(d), t = t.message, e.setData({
                    redPackets: t.redPackets,
                    svip_redpacket: t.svip_redpacket
                });
                var r = {
