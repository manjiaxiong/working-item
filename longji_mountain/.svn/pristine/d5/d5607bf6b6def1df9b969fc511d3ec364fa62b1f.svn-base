...
Page({
    ...
    onLoad: function(a) {
        ...
        a.pindan_id > 0 && (o.data.pindan_id = a.pindan_id), o.setData({
            ...
            success: function(a) {
                ...
                }), t.utilwmall.setStorageSync("store", a.store), o.onCalculate(), o.data.shareData.title = a.store.title, 
                o.data.shareData.path = "/lala/store/goods?sid=" + a.store.id, o.data.store.data.wxapp) {
    ...
    onPlus: function(a) {
        ...
        if (1 == o.data.cart.is_buysvip && (e = 1), "selectSvip" == a.detail.from) {
            ...
            if (!1 !== g) {
                ...
                if (d = l.id, n = l.activeOptionId, !l.total) return t.utilwmall.toast("库存不足"), !1;
            }
    ...
    onSubmit: function() {
        ...
        t.utilwmall.jump2url(o, "navigateTo");
    },
