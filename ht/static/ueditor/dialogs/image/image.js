    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            var _this = this,
                ...
                console.log('actionUrl::'+actionUrl,editor.getOpt('imageActionName'))
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                console.log(utils.str2json(responseText), ret)
                var $file = $('#' + file.id);
                try {
        ...
        getInsertList: function () {
            ...
            for (i = 0; i < this.imageList.length; i++) {
                data = this.imageList[i].data;
                console.log('prefix:::::::',data,prefix)
                list.push({
                    src: prefix + data.filePath,
                    _src: prefix + data.filePath,
                    title: data.title,
                    alt: data.original,
                    floatStyle: align
                });
    ...
    OnlineImage.prototype = {
        ...
        getImageData: function () {
            ...
            if (!_this.listEnd && !this.isLoadingData) {
                ...
                console.log(url,editor.getOpt('imageManagerActionName'))
