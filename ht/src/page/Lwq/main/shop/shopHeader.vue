<template>
  <div>
      ...
      <table border="0" cellpadding="0" cellspacing="0">
        ...
        <tbody>
          <tr class="juz" v-for="(item,index) in arr" :key="index">
            ...
            <td class="btn">
              <div>
                <el-button size="small" type="danger" @click="dele(item.showId)">删除</el-button>
              </div>
            </td>
          </tr>
        </tbody>
    ...
    <div v-if="centerDialogVisible">
      <el-dialog title="添加头部商品" :visible.sync="centerDialogVisible" :close-on-click-modal="false" width="30%" center>
        <div class="myinput">
          <span>选择分类</span>
