...
<!--              <td class="btn">-->
<!--                <div v-if="name=='回收'">-->
<!--                  <el-button size="small" type="warning" @click="shangjia1(item.id)">上架</el-button>-->
<!--                  <el-button size="small" type="danger"   @click="qingkong(item.id)">清空</el-button>-->
<!--                </div>-->
<!--                <div v-else-if="name=='下架'">-->
<!--                  <el-button size="small" type="success" @click="xiugai(item.id)">修改</el-button>-->
<!--                  <el-button size="small" type="warning" @click="shangjia(item.id)">上架</el-button>-->
<!--                  <el-button size="small" type="danger" @click="dele(item.id)">删除</el-button>-->
<!--                </div>-->
<!--                <div v-else>-->
<!--                  <el-button size="small" type="success" @click="xiugai(item.id)">修改</el-button>-->
<!--                  <el-button size="small" type="warning" @click="xiajia(item.id)">下架</el-button>-->
<!--                  <el-button size="small" type="danger" @click="dele(item.id)">删除</el-button>-->
<!--                </div>-->
<!--              </td>-->
            </tr>
