...
export default {
  ...
  mounted(){
    ...
    .then(res=>{
      ...
      }else if(this.title == 'PV'){
        this.initData = res.data.data.pvList
      }else if(this.title == '人均PV'){
        this.initData = res.data.data.gdpPvList
      }else if(this.title == 'IP'){
        this.initData = res.data.data.ipList
      }else if(this.title == '移动UV占比'){
        this.initData = res.data.data.dUvList
      }else if(this.title == '移动UV'){
        this.initData = res.data.data.sUvList
      }else if(this.title == '跳出率'){
        this.initData = res.data.data.jumpOutRateList
      }
