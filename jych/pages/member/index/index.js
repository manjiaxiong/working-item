    ...
    play: function(t) {
        ...
        a.onPlay(function() {
            var t = setInterval(function() {
                ...
                c[e].audiowidth = i, c[e].Time = t, c[e].audiotime = u, c[e].seconds = o, s.setData({
                    audios: c
                });
            }, 1e3);
        });
        var r = t.currentTarget.dataset.audio, n = t.currentTarget.dataset.time, o = t.currentTarget.dataset.pausestop, u = t.currentTarget.dataset.loopplay;
        ...
        var c = s.data.audios;
        c[e] || (c[e] = {}), a.paused && 0 == n ? (a.src = r, a.play(), 1 == u && (a.loop = !0), 
        c[e].status = !0, s.pauseOther(e)) : a.paused && n > 0 ? (a.play(), 0 == o ? a.seek(n) : a.seek(0), 
